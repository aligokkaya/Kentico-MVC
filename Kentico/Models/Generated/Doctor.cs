...
namespace CMS.DocumentEngine.Types.Kentico
{
	...
	public partial class Doctor : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Kentico.Doctor";
		...
		public string Speciality
		{
			get
			{
				return ValidationHelper.GetString(GetValue("Speciality"), @"");
			}
			set
			{
		...
		public partial class DoctorFields : AbstractHierarchicalObject<DoctorFields>
		{
			...
			public string Speciality
			{
				get
				{
					return mInstance.Speciality;
				}
				set
				{
					mInstance.Speciality = value;
				}
			}
